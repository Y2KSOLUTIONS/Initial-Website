  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-24 px-6 text-center">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-royal-blue/10 rounded-full blur-3xl -z-10" />
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] h-[300px] bg-teal/10 rounded-full blur-3xl -z-10" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            <span className="text-white font-medium">We&apos;ll make that happen.</span>
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link
              href="/portfolio"
              className="border border-white/20 text-white font-medium px-8 py-4 rounded-full text-lg hover:bg-white/5 transition-colors w-full sm:w-auto text-center"
            >
              See Our Work
            </Link>
          </div>
      ...
      {/* Stats bar */}
      <section className="bg-[#111827] border-y border-white/10 py-8 px-6">
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg leading-relaxed max-w-3xl mx-auto">
            ...
            outdated designs, invisible on Google. <span className="text-white font-medium">We exist to make sure that never happens to you.</span>
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((s) => (
              <div
                key={s.title}
                className="bg-[#0A0F1E] border border-white/10 rounded-2xl p-6 card-glow transition-all duration-300 hover:-translate-y-1"
              >
          ...
          <div className="text-center mt-10">
            <Link
              href="/services"
              className="border border-white/20 text-white font-medium px-6 py-3 rounded-full hover:bg-white/5 transition-colors"
            >
              View All Services →
            </Link>
          </div>
